    ...
    const r = {
        ...
        gameMode: {
            enduro: {
                ...
                displayScore() {
                    o.display.endGame(!0, "JUEGO TERMINADO", n.game.gameScore)
                }
            },
            rush: {
                initSpeed: 6,
                ...
                end: ()=>s.a.value <= 0 && (s.a.pause(),
                n.game.stop(),
                n.game.gameStatut = "end",
                !0),
                displayScore() {
                    o.display.endGame(!0, "TIEMPO!", n.game.gameScore, "puntos")
                }
            },
            sprint: {
                initSpeed: 6,
                ...
                lineCheck(e) {
                    ...
                    return n.game.lines >= this.linesToWin && (s.a.pause(),
                    n.game.stop(),
                    n.game.gameStatut = "end",
                    !0)
                },
                displayScore() {
                    o.display.endGame(!0, this.linesToWin + " LINEAS HECHAS!", s.a.value, "segundos")
                }
            }
        }
    }
...
, function(e, t, i) {
    ...
    const a = {
        ...
        generatePlaygroundGrid() {
            ...
            for (let t = 0; t < n.init.columns; t++) {
                ...
                t.className = "playgroundBottom taken",
                e.appendChild(t)
            }
        ...
        animateDeleteLine(e) {
            if (4 === e.length) {
                o.a.play(o.a.tetris);
                for (let t = 0; t < n.init.columns; t++)
                    e.forEach(e=>this.blocks[n.init.columns * e + t].className = "playgroundBlock taken specialErasing")
            } else {
                o.a.play(o.a.line);
                for (let t = 0; t < n.init.columns; t++)
                    e.forEach(e=>this.blocks[n.init.columns * e + t].className = "playgroundBlock taken erasing")
            }
        },
        deleteLine(e) {
            for (let t = 0; t < e.length; t++) {
                ...
                for (let s = 0; s < e[t] * n.init.columns; s++)
                    i.push(this.blocks[s].className),
                    this.blocks[s].className = "playgroundBlock";
                for (let s = 0; s < e[t] * n.init.columns; s++) {
      ...
      , r = {
        ...
        initTetromino() {
            "notStarted" === S.gameStatut && (this.theTetrominoes = this.createTetrominoes(n.init.columns),
        ...
        moveDown() {
            this.undraw(),
            this.position += n.init.columns,
            this.draw()
        },
        smackDown() {
            if (this.canMoveDown) {
                for (this.undraw(); !this.freeze(); )
                    this.position += n.init.columns;
                o.a.play(o.a.smack),
                o.a.justSmashed = !0,
                this.draw()
        ...
        moveLeft() {
            this.current.some(e=>(e + this.position) % n.init.columns == 0) || this.lateralBlock("left") || (o.a.play(o.a.move),
            this.undraw(),
            this.position--,
            this.draw())
        },
        pushDown() {
            "init" === a.deletingAnimation && (!this.freeze() && this.canMoveDown ? (o.a.play(o.a.move),
            this.undraw(),
            this.position += n.init.columns,
            this.draw()) : (this.canMoveDown && o.a.play(o.a.land),
            this.canMoveDown = !1))
        },
        moveRight() {
            this.current.some(e=>(e + this.position + 1) % n.init.columns == 0) || this.lateralBlock("right") || (o.a.play(o.a.move),
            this.undraw(),
            this.position++,
            this.draw())
        },
        freeze() {
            return !!this.current.some(e=>a.blocks[this.position + e + n.init.columns].classList.contains("taken")) && (this.canMoveDown = !1,
            this.current.forEach(e=>{
    ...
    const y = {
        handleKeyPress(e) {
            "play" === S.gameStatut && (e.keyCode === l && r.moveLeft(),
        ...
        handleTouchPress(e) {
            "play" === S.gameStatut && ("controlRight" === e.target.id && r.moveRight(),
        ...
        setListener(e) {
            ...
            document.addEventListener("keydown", this.handleKeyPress)) : (document.getElementById("touchControlContainer").removeEventListener("click", this.handleTouchPress),
    ...
    const S = {
        ...
        quit() {
            this.restore(),
            a.removeAllGrid(),
            document.getElementById("startButton").innerHTML = "Empezar",
        ...
        start() {
            ...
            "notStarted" === this.gameStatut && (o.a.playSong(o.a.playingTheme),
            r.drawNew(),
            document.getElementById("startButton").classList.remove("buttonPulse")),
            "pause" === this.gameStatut || "notStarted" === this.gameStatut ? (o.a.playSong(o.a.playingTheme),
            this.timerId = setInterval(this.run.bind(this), n.init.speedArray[this.speed - 1]),
            n.init.gameMode[this.gameMode].start(),
            document.getElementById("startButton").innerHTML = "Pausa",
            document.getElementById("startButton").classList.remove("buttonPulse"),
            d.display.pause(!1),
            this.gameStatut = "play") : this.pause()
        },
        pause() {
            ...
            document.getElementById("startButton").innerHTML = "Reanudar",
            document.getElementById("startButton").classList.add("buttonPulse"),
            clearInterval(this.timerId)
        },
        reset() {
        ...
        saveTetromino() {
            r.canBeSaved && (r.saved.tetromino.length > 0 ? (r.undraw(),
            r.switchSaved(),
            r.drawSaved(),
            r.undraw(),
            r.draw()) : (r.saveTetromino(),
            r.drawSaved(),
            r.undraw(),
            r.drawNew()),
            o.a.play(o.a.save))
        ...
        run() {
            if ("onGoing" === a.deletingAnimation)
                return;
            if (n.init.gameMode[this.gameMode].end())
                return o.a.stop(o.a.playingTheme),
                void n.init.gameMode[this.gameMode].displayScore();
            const e = a.lineIsMade()
              , t = r.freeze();
            if (t && e.length && "done" !== a.deletingAnimation)
                return n.init.gameMode[this.gameMode].lineCheck(e),
                this.lines += e.length,
                this.updateScore(),
            ...
            if (t) {
                ...
                a.deletingAnimation = "init",
                r.drawNew();
                this.loseCondition() && (o.a.stop(o.a.playingTheme),
                o.a.play(o.a.gameover),
                this.stop(),
                this.gameStatut = "lost",
                "enduro" === this.gameMode ? d.display.endGame(!0, "JUEGO TERMINADO", this.gameScore, "puntos") : (d.display.endGame(!0, "PERDISTE", " ", " "),
                s.a.pause()))
            } else
                r.moveDown()
        },
        stop() {
            clearInterval(this.timerId),
            document.getElementById("startButton").innerHTML = "Jugar de nuevo"
        },
...
, function(e, t, i) {
    ...
    const o = {
        tactil: !1,
        playgroundPanel(e) {
            e ? (document.getElementById("sidePanelRight").classList.remove("hide"),
            document.getElementById("sidePanelLeft").classList.remove("hide"),
            document.getElementById("playgroundContainer").classList.remove("hide")) : (document.getElementById("sidePanelRight").classList.add("hide"),
            document.getElementById("sidePanelLeft").classList.add("hide"),
            document.getElementById("playgroundContainer").classList.add("hide"))
        },
        mainMenu(e) {
            e ? (document.getElementById("mainMenu").classList.remove("hide"),
            this.touchControl(!1)) : (document.getElementById("mainMenu").classList.add("hide"),
        ...
        endGame(e, t="GAME OVER", i, n) {
            ...
            e && (document.getElementById("endGameTitle").innerHTML = t,
...
, function(e, t, i) {
    ...
    document.getElementById("musicSwitch").addEventListener("change", (function() {
        this.checked ? (a.a.enableMusic(!0),
        "play" === r.game.gameStatut && a.a.playSong(a.a.theme1)) : (a.a.enableMusic(!1),
        a.a.stop(a.a.theme1))
    }
    )),
